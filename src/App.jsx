...
function App() {
  ...
  // }
  //    api key :2da8977f2c3e42738b462822241109
  // api call url:http://api.weatherapi.com/v1/current.json?key=2da8977f2c3e42738b462822241109&q=india&aqi=no 
  ...
  const searchWeatherHandler = () => {
    ...
    if (search !== "") {
      axios.get(
        `http://api.weatherapi.com/v1/current.json?key=2da8977f2c3e42738b462822241109&q=${search}&aqi=no`
        // `https://api.openweathermap.org/data/2.5/weather?q=${search}&appid=3265874a2c77ae4a04bb96236a642d2f&units=metric`
      )
        .then(
          (response) => {
  ...
  const historySearchHandler = async (data) => {
    ...
    if (data !== "") {
      axios.get(
        `http://api.weatherapi.com/v1/current.json?key=2da8977f2c3e42738b462822241109&q=${data}&aqi=no`
